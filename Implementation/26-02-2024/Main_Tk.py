...
class Pokedex(tk.Tk):
    def __init__(self):
        ...
        self.Pokedex_Button = tk.Button(self, text="Pokedex", height=5, width=10, command=self.Pokedex)
        self.Pokedex_Button.grid(row=0, column=0)

        #Button To Get Up Pokemon Team Page/Position
        self.Team_Button = tk.Button(self, text="Team", height=5, width=10, command=self.Team)
        self.Team_Button.grid(row=1,column=0)

        #Button To Get Up Login Page/Position
        self.Log_Button = tk.Button(self, text="Login", height=5, width=10, command=self.login)
        ...
        self.Exit_Button = tk.Button(self, text="Exit Program", height=5, width=10, command=self.Exit_Program)
    ...
    def Team(self):
        self.clear_window()
        self.menu()
        self.Team_Label = tk.Label(self, text="Not Logged In No Team Available", font=('Arial',19),)
    ...
    def Logged_Menu(self):
        ...
        #Button To Get Up The Pokedex Page/Position
        self.selfdex_Button = tk.Button(self, text="Pokedex", height=5, width=10, command=self.PokedexL)
        self.selfdex_Button.grid(row=0, column=0)

        #Button To Get Up Pokemon Team Page/Position
        self.Team_Button = tk.Button(self, text="Team", height=5, width=10, command=self.TeamL)
        self.Team_Button.grid(row=1,column=0)

        #Button To Logout
        self.Logout_Button = tk.Button(self, text="Logout", height=5, width=10, command=self.menu)
    ...
    def login(self):
        ...
        self.register_Button.grid(row=2, column=3, columnspan=2,)
    ...
    def register(self):
        ...
        self.reg_Button.grid(row=3, column=2, columnspan=2)

        #Button To Get Up Login Page/Position
        self.Log_Button = tk.Button(self, text="Login", command=self.login)
        self.Log_Button.grid(row=3, column=3, columnspan=2)
    ...
    def reg(self):
        ...
        with open("UserData.csv",mode="a", newline="") as f:
            ...
            if password == password_2: #Makes Sure The Password Entered Is Correct
                ...
                self.Register_Label.grid(row=4, column=3, columnspan=2)
                self.after(2000, self.clear_label)
            else:
                self.RegisterNo_Label = tk.Label(self, text="Registration Failed Please Try Again!")
                self.RegisterNo_Label.grid(row=4, column=3, columnspan=2)
    ...
    def clear_label(self):
        ...
        self.clear.grid(row=4, column=3, columnspan=2)
