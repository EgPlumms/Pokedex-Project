...
def add(): #adds a pokemon to the team
    ...
    logged_menu()
    #if  pokiman == True:
   #     print("Is "pokemans,"pokemon You Want To Add?")
    #else:
...
def find(): #find a pokemon in the system 
    ...
    pokemon = requests.get('https://pokeapi.co/api/v2/pokemon/'+pokemans) #Accesses The Url And Find Specific selfmon User Asks For (Stores It As Variable selfmon)
    pokeInfo = json.loads(pokemon.text) #Turns selfmon Text Into Json, Can Be Used Like A Dictionary
    ...
    if start_over.lower() == 'yes': #Sends The User Back To The Start Of This Function.
        ...
        if Back.lower() == 'yes':
            ...
            print("Thanks For Viewing The selfdex!")
            exit()
