...
class Pokedex(tk.Tk):
    ...
    def Pokedex(self):
        ...
        self.PokedexS_Button = tk.Button(self, text="Search", command=self.poke)
    ...
    def pokeL(self):
        ...
        print(Info["abilities"][0]["ability"]["name"])
        
        self.abilities_Label = tk.Label(self, text="Abilities:")
        self.abilities_Label.grid(row=2,column=1)

        self.pokemon_label = tk.Label(self, text=Info["abilities"][0]["ability"]["name"])
        self.pokemon_label.grid(row=2,column=2)
